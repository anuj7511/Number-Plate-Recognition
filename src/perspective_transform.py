...
def preprocessForPerspecive(img, clahe_clipLimit=7, clahe_tileGridSize=16, erosion_iters=1, dilation_iters=1):
    ...
    img_binary_lp[:BOUDARY_THICKNESS,:] = 0.
    img_binary_lp[-BOUDARY_THICKNESS:,:] = 0.
    img_binary_lp[:,:BOUDARY_THICKNESS] = 0.
    img_binary_lp[:,-BOUDARY_THICKNESS:] = 0.
...
def perspectiveTransform(
    ...
    processed_img, img_original = preprocessForPerspecive(image, clahe_clipLimit=clahe_clipLimit, erosion_iters=erosion_iters, dilation_iters=dilation_iters)
